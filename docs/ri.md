...
Impact Analytics uses the Growth Goal Low as the benchmark for whether or not a student met their growth goals for ACM/Team performance metrics. However, when goal setting with students, we encourage using the Growth Goal High to encourage students to challenge themselves.
